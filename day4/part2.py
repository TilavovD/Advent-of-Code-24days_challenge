...
for row_index in range(len(data)):
	...
	if int(record2_start) >= int(record1_start) and int(record2_start) <= int(record1_end) or int(record2_end) >= int(record1_start) and int(record2_end) <= int(record1_end): 
		count += 1
	elif int(record1_start) >= int(record2_start) and int(record1_start) <= int(record2_end) or int(record1_end) >= int(record2_start) and int(record1_end) <= int(record2_end):
